package com.farmonautsdk.android;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private ImageView farmonautLogoImageView;

    private String logoUrl = "https://farmonaut.com/wp-content/uploads/2020/01/Farmonaut_Logo_Black.png";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UID = getResources().getString(R.string.uid);
        ...
        farmonautLogoImageView = findViewById(R.id.farmonaut_logo);

        Picasso.get()
                .load(logoUrl)
                .into(farmonautLogoImageView);
